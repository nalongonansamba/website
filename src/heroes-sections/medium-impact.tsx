...
export const MediumImpactHero: FC<Route['hero']> = ({ links, media, richText }) => {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      <div className="container md:max-w-7xl relative z-10 flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-0 py-20 lg:py-28">
            ...
            <ul className="flex flex-row flex-wrap gap-3">
              {links.map(({ link }, i) => (
                <li key={i}>
                  <LinkManager
                    {...link}
                    className={cn('h-11 px-6 rounded-none text-sm font-medium tracking-wide')}
                  />
                </li>
              ))}
            </ul>
          ...
          <div className="relative w-full lg:w-[55%] lg:pl-8">
            <div
              className={cn(
                ...
                'lg:translate-x-8 lg:-translate-y-4 max-h-[50vh]',
            ...
            <div
              className={cn(
                ...
                'ring-1 ring-white/10 max-h-[20vh]',
                'translate-y-4',
              )}
            >
              <MediaPreview imgClassName="w-full h-auto object-cover" priority resource={media} />
